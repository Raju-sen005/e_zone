...
import QuantityAndMessage from '../components/QuantityAndMessage.js';
...
const Edius11 = () => {
    ...
    const handleAddToCart = () => {
        if (isLoggedIn) {
            dispatch(addToCart({ productId: productDetail?._id, quantity }));
            navigate("/cart");
        } else {
            navigate("/login");
        }
    ...
    const handleWishlist = () => {
        if (isLoggedIn) {
            dispatch(addToWishlist({ productId: productDetail?._id }));
            navigate("/wishlist");
        } else {
            navigate("/login");
        }
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6 col-md-12 col-12">
                                    <div className="product-details ps-lg-4">
                                        ...
                                        <h2 className="product-title mb-3">{productDetail?.name}</h2>
                                        ...
                                        <div className="product-price-wrapper mb-4">
                                            <span className="product-price regular-price">₹{productDetail?.sellPrice}</span>
                                            <del className="product-price compare-price ms-2">₹{productDetail?.mrp}</del>
                                        </div>
                                        <div className="product-sku product-meta mb-1">
                                            <img src={`${process.env.PUBLIC_URL}/assets/img/products/Grass-Valley-icn.png`} className="grass-icn" alt="" />
                                        </div>
                                        ...
                                        {/* <!-- add to cart start --> */}
                                        {/* <form className="product-form" action="/cart"> */}
                                        <div
                                            className="product-form-buttons d-flex align-items-center justify-content-between mt-4">
                                            <button className="position-relative btn-atc btn-add-to-cart loader"
                                                onClick={handleAddToCart} >ADD TO CART</button>
                                            <button onClick={handleWishlist} className="product-wishlist">
                                        ...
                                        <div className="buy-it-now-btn mt-2">
                                            <button onClick={handleAddToCart} className="position-relative btn-atc btn-buyit-now">BUY IT
                                                NOW</button>
                                        </div>
                                        {/* </form> */}
                                        {/* <!-- add to cart end --> */}
                        ...
                        <div className="container">
                            <div className="tab-list product-tab-list">
                                <nav className="nav product-tab-nav">
                                    <Link className="product-tab-link tab-link active" to="#pdescription"
                                        data-bs-toggle="tab" style={{ textDecoration: "none" }}>Description</Link>
                                    <Link className="product-tab-link tab-link" to="#pshipping" data-bs-toggle="tab" style={{ textDecoration: "none" }}>Shipping &
                                        Returns</Link>
                                    <Link className="product-tab-link tab-link" to="#pstyle" data-bs-toggle="tab" style={{ textDecoration: "none" }}>Style with</Link>
                                    <Link className="product-tab-link tab-link" to="#preview" data-bs-toggle="tab" style={{ textDecoration: "none" }}>Reviews</Link>
                                </nav>
                            </div>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-7 col-md-12 col-12">
                                            <div className="desc-content">
                                                <h4 className="heading_18 mb-3">
                                                    Edius 11</h4>
                                                <p className="text_16 mb-4">Edit Zone is the authorized reseller of Edius 11 and we
                                                    are presenting you Edius in a bundle version with Edius 11 , Mync 11, Chorus
                                                    Hub 11 & Training Class.
                                                </p>

                                                <p className="text_16 mb-4">EDIUS 11 marks the start of a new era in nonlinear
                                                    editing. EDIUS 11 comes with a completely redesigned core engine along with
                                                    a modular concept allowing even more performance for fully customizable
                                                    workflows.
                                                </p>

                                                <p className="text_16 mb-4">Best of all, with EDIUS 11, there are no subscription
                                                    fees — you buy it, you keep it — with a permanent license with free updates
                                                    throughout the life EDIUS 11
                                                </p>

                                                <p className="text_16 mb-4">
                                                    Grass Valley® is pleased to announce the unveiling of EDIUS® 11 at IBC 2023
                                                    in stand 9-A01.
                                                </p>

                                                <p className="text_16 mb-4">
                                                    EDIUS 11 comes with a set of AI tools allowing the editor to concentrate on
                                                    the creative process. EDIUS 11 is also ready for the Integration of
                                                    third-party AI services – online as well as offline. Mync® 11 is included as
                                                    a powerful content management system for any type of digital media with a
                                                    tight integration into EDIUS 11. To provide for group collaboration of EDIUS
                                                    projects connecting multiple EDIUS 11 clients, Grass Valley is introducing
                                                    the Chorus Hub 11 Server system.
                                                </p>


                                                <p className="text_16 mb-4">“This latest version of EDIUS revolutionizes
                                                    next-generation creatives with its advanced Chorus Hub architecture” said
                                                    Katsushi Takeuchi, Vice President and General Manager Editing Systems for
                                                    Grass Valley. “In addition to advanced video production with numerous new
                                                    functions, the user experience has been improved to enable more
                                                    user-friendly and comfortable operation. With the addition of the Chorus Hub
                                                    11 Server and strong integration with Mync 11, EDIUS is firmly positioned
                                                    for craft editors today and for years to come.”
                                                </p>
                                        ...
                                        <div className="col-lg-5 col-md-12 col-12">
                                            <div className="desc-img">
                                                <img src={`${process.env.PUBLIC_URL}/assets/img/product.jpg`} alt="img" />
                                            </div>
                                        </div>
                                        <div className="col-lg-12 col-md-12 col-12">
                                            <div className="desc-content mt-2">

                                                <p className="text_16 mb-3">
                                                    An AI-based voice recognition allows the editor to eliminate even extreme
                                                    noise better than ever before. To further optimize audio, EDIUS 11 includes
                                                    a new dedicated Audio Editor which also supports an AI-based speech-to-text
                                                    workflow. A new integrated, fast, and powerful Titler allows the user to
                                                    burn text as subtitles into video.
                                                </p>

                                                <p className="text_16 mb-3">
                                                    Mync 11 provides users with advanced content management features to quickly
                                                    prepare the footage for editing. A new EDIUS 11 Mync tab puts these tools
                                                    and assets at the editor’s fingertips directly in EDIUS.
                                                </p>

                                                <p className="text_16 mb-3">
                                                    “This new release combines the stability, benchmark-setting performance, and
                                                    extensive format support of EDIUS with a wide range of new features,
                                                    powerful AI tools, and an open structure ready for today and future
                                                    demands,” said Michael Lehmann-Horn, CEO of magic multi media, EDIUS
                                                    distributor and operator of EDIUS.NET.
                                                </p>

                                                <p className="text_16 mb-3">
                                                    EDIUS 11 will be available in a variety of versions. EDIUS 11 Pro – the
                                                    standard version, EDIUS 11 Workgroup that provides enhanced connectivity
                                                    options, and EDIUS 11 Broadcast which is specifically designed for broadcast
                                                    stations. As in the past, educational licenses and upgrades from older
                                                    versions of EDIUS will be available. Those who purchase EDIUS X from
                                                    September 15th through October 31st, 2023, will get a free EDIUS 11 upgrade.

                                                </p>

                                                <p className="text_16">EDIUS 11, Mync 11 and the Chorus Hub 11 Server are scheduled
                                                    to begin shipping on October 11th. More information will be available at
                                                    that time at EDIUS.NET.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
