                        ...
                        <div className="col-lg-9 col-md-12 col-12">
                            <div className="article-rte">
                                <div className="article-img">
                                    <img src={`${process.env.PUBLIC_URL}/assets/img/blog/furniture-9.jpg`} alt="img"/>
                                </div>
                                <div className="article-meta">
                                    <h2 className="article-title">Delivering What Consumers Really Value?</h2>
                                    <div className="article-card-published text_14 d-flex align-items-center">
                                        ...
                                        <Link to="/" className="article-date d-flex align-items-center">
                                        ...
                                        <Link to="article.html" className="article-date d-none d-sm-flex align-items-center">
                                ...
                                <div className="next-prev-article mt-5 d-flex align-items-center justify-content-between">
                                    <Link to="article.html" className="article-btn prev-article-btn mt-2">PREV ARTICLE</Link>
                                    <Link to="article.html" className="article-btn next-article-btn active mt-2">NEXT ARTICLE</Link>
                                </div>
                                ...
                                <div className="comments-section mt-100 home-section overflow-hidden">
                                    ...
                                    <div className="comments-area">
                                        <div className="d-flex comments-item">
                                            <div className="comments-img">
                                                <img src={`${process.env.PUBLIC_URL}/assets/img/people/1.jpg`} alt="img"/>
                                            </div>
                                            <div className="comments-main">
                                                <div className="comments-main-content">
                                                    <div className="comments-meta">
                                                        ...
                                                        <p className="comments">The second Bag is a corner room with double windows. The Bag has fabulous spa new appliances, and a laundry area. Other features include rich herringbone floors.</p>
                                                    </div>
                                                    <button type="button" className="btn-reply bg-transparent d-flex align-items-center">
                                                ...
                                                <div className="comments-replied">
                                                    <div className="d-flex comments-item">
                                                        <div className="comments-img">
                                                            <img src={`${process.env.PUBLIC_URL}/assets/img/people/2.jpg`} alt="img"/>
                                                        </div>
                                                        <div className="comments-main">
                                                            <div className="comments-meta">
                                        ...
                                        <div className="d-flex comments-item">
                                            <div className="comments-img">
                                                <img src={`${process.env.PUBLIC_URL}/assets/img/people/3.jpg`} alt="img"/>
                                            </div>
                                            <div className="comments-main">
                                                <div className="comments-main-content">
                                                    <div className="comments-meta">
                                    ...
                                    <div className="comment-form-area">
                                        <div className="form-header">
                                            ...
                                            <p className="form-subtitle">All fields marked with an asterisk (*) are required</p>
                                        </div>
                                        <form action="#" className="comment-form">
                                            ...
                                            <button type="submit" className="position-relative review-submit-btn mt-4">SUBMIT</button>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div className="filter-drawer blog-sidebar">
                                <div className="filter-widget widget-blogger text-center">
                                    <div className="blogger-img mb-3">
                                        <img className="rounded" src={`${process.env.PUBLIC_URL}/assets/img/people/blogger.jpg`} alt="img"/>
                                    </div>
                                    <h4 className="blogger-name heading_18 mb-1">Shakespeare D. Willaim</h4>
                                    ...
                                    <p className="blogger-desc mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit.Veritatis distinctio, odio eligendi suscipit reprehenderit atque</p>       
                                    ...
                                    <div className="filter-related">
                                        <div className="related-item related-item-article d-flex">
                                            <div className="related-img-wrapper">
                                                <img className="related-img" src={`${process.env.PUBLIC_URL}/assets/img/blog/furniture-1.jpg`} alt="img"/>
                                            </div>
                                            <div className="related-product-info">
                                                <h2 className="related-heading text_14">
                                                    <Link to="article.html">Modern furniture in velvet</Link>
                                                </h2>
                                        ...
                                        <div className="related-item related-item-article d-flex">
                                            <div className="related-img-wrapper">
                                                <img className="related-img" src={`${process.env.PUBLIC_URL}/assets/img/blog/furniture-2.jpg`} alt="img"/>
                                            </div>
                                            <div className="related-product-info">
                                                <h2 className="related-heading text_14">
                                                    <Link to="article.html">Ultimate luxury furniture</Link>
                                                </h2>
                                                <p className="article-card-published text_12 d-flex align-items-center mt-2">
                                                    <span className="article-date d-flex align-items-center">
                                                        <span className="icon-publish">
                                        ...
                                        <div className="related-item related-item-article d-flex">
                                            <div className="related-img-wrapper">
                                                <img className="related-img" src={`${process.env.PUBLIC_URL}/assets/img/blog/furniture-3.jpg`} alt="img"/>
                                            </div>
                                            <div className="related-product-info">
                                                <h2 className="related-heading text_14">
                                                    <Link to="article.html">Small bedroom look bigger</Link>
                                                </h2>
                                                <p className="article-card-published text_12 d-flex align-items-center mt-2">
                                                    <span className="article-date d-flex align-items-center">
                                                        <span className="icon-publish">
                                        ...
                                        <div className="related-item related-item-article d-flex">
                                            <div className="related-img-wrapper">
                                                <img className="related-img" src={`${process.env.PUBLIC_URL}/assets/img/blog/furniture-4.jpg`} alt="img"/>
                                            </div>
                                            <div className="related-product-info">
                                                <h2 className="related-heading text_14">
                                                    <Link to="article.html">Update your living room</Link>
                                                </h2>
                                                <p className="article-card-published text_12 d-flex align-items-center mt-2">
                                                    <span className="article-date d-flex align-items-center">
                                                        <span className="icon-publish">
                                        ...
                                        <div className="related-item related-item-article d-flex">
                                            <div className="related-img-wrapper">
                                                <img className="related-img" src={`${process.env.PUBLIC_URL}/assets/img/blog/furniture-5.jpg`} alt="img"/>
                                            </div>
                                            <div className="related-product-info">
                                                <h2 className="related-heading text_14">
                                                    <Link to="article.html">Choose the right fabric</Link>
                                                </h2>
                                                <p className="article-card-published text_12 d-flex align-items-center mt-2">
                                                    <span className="article-date d-flex align-items-center">
                                                        <span className="icon-publish">
                                ...
                                <div className="filter-widget">
                                    ...
                                    <ul className="filter-tags list-unstyled">
                                        <li className="tag-item"><Link to="/">Popular</Link></li>
                                        <li className="tag-item"><Link to="/">Agency</Link></li>
                                        <li className="tag-item"><Link to="/">Furniture</Link></li>
                                        <li className="tag-item"><Link to="/">creative</Link></li>
                                        <li className="tag-item"><Link to="/">design</Link></li>
                                        <li className="tag-item"><Link to="/">modern</Link></li>
                                        <li className="tag-item"><Link to="/">UX</Link></li>
                                        <li className="tag-item"><Link to="/">web</Link></li>
                                        <li className="tag-item"><Link to="/">bag</Link></li>
                                        <li className="tag-item"><Link to="/">shoe</Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
