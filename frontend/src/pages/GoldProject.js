                                ...
                                "responsive": [
                                  ...
                                  },
                                  {
                                    ...
                                    <div className="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                                        ...
                                        <img src={`${process.env.PUBLIC_URL}/assets/img/banner/banner-1.jpg`} alt="" />
                                    ...
                                    <div className="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                                        ...
                                        <img src={`${process.env.PUBLIC_URL}/assets/img/banner/banner-2.jpg`} alt="" />

                                    </div>

                                    <div className="article-slick-item" data-aos="fade-up" data-aos-duration="700">

                                        <img src={`${process.env.PUBLIC_URL}/assets/img/banner/banner-3.jpg`} alt="" />

                                    </div>

                                    <div className="article-slick-item" data-aos="fade-up" data-aos-duration="700">

                                        <img src={`${process.env.PUBLIC_URL}/assets/img/banner/banner-4.jpg`} alt="" />

                                    </div>

                                    <div className="article-slick-item" data-aos="fade-up" data-aos-duration="700">

                                        <img src={`${process.env.PUBLIC_URL}/assets/img/banner/banner-5.jpg`} alt="" />
                            ...
                            <div className="row">
                                    ...
                                    <div className="product-gallery product-gallery-vertical d-flex">
                                        ...
                                        "asNavFor": ".img-thumb-slider"
                                                ...
                                                <div className="img-large-wrapper">
                                                    <Link to={`${process.env.PUBLIC_URL}/assets/img/products/as-1.png`} data-fancybox="gallery">
                                                        <img src={`${process.env.PUBLIC_URL}/assets/img/products/as-1.png`} alt="img" />
                                                    </Link>
                                                </div>
                                                <div className="img-large-wrapper">
                                                    <Link to={`${process.env.PUBLIC_URL}/assets/img/products/as-2.jpg`} data-fancybox="gallery">
                                                        <img src={`${process.env.PUBLIC_URL}/assets/img/products/as-2.jpg`} alt="img" />
                                                    </Link>
                                                </div>
                                                <div className="img-large-wrapper">
                                                    <Link to={`${process.env.PUBLIC_URL}/assets/img/products/as-3.jpg`} data-fancybox="gallery">
                                                        <img src={`${process.env.PUBLIC_URL}/assets/img/products/as-3.jpg`} alt="img" />
                                                    </Link>
                                                </div>
                                                <div className="img-large-wrapper">
                                                    <Link to={`${process.env.PUBLIC_URL}/assets/img/products/as-4.jpg`} data-fancybox="gallery">
                                                        <img src={`${process.env.PUBLIC_URL}/assets/img/products/as-4.jpg`} alt="img" />
                                                    </Link>
                                                </div>
                                                <div className="img-large-wrapper">
                                                    <Link to={`${process.env.PUBLIC_URL}/assets/img/products/as-5.jpg`} data-fancybox="gallery">
                                                        <img src={`${process.env.PUBLIC_URL}/assets/img/products/as-5.jpg`} alt="img" />
                                                    </Link>
                                                </div>
                                                <div className="img-large-wrapper">
                                                    <Link to={`${process.env.PUBLIC_URL}/assets/img/products/as-6.jpg`} data-fancybox="gallery">
                                                        <img src={`${process.env.PUBLIC_URL}/assets/img/products/as-6.jpg`} alt="img" />
                                                    </Link>
                                                </div>

                                                <div className="img-large-wrapper">
                                                    <Link to={`${process.env.PUBLIC_URL}/assets/img/products/as-7.png`} data-fancybox="gallery">
                                                        <img src={`${process.env.PUBLIC_URL}/assets/img/products/as-7.png`} alt="img" />
                                                    </Link>
                                                </div>

                                                <div className="img-large-wrapper">
                                                    <Link to={`${process.env.PUBLIC_URL}/assets/img/products/as-8.jpg`} data-fancybox="gallery">
                                                        <img src={`${process.env.PUBLIC_URL}/assets/img/products/as-8.jpg`} alt="img" />
                                                    </Link>
                                                </div>
                                ...
                                <div className="col-lg-6 col-md-12 col-12">
                                    <div className="product-details ps-lg-4">
                                        ...
                                        <h2 className="product-title mb-3">Gold Projects Edit Zone</h2>
                                        ...
                                        <div className="product-price-wrapper mb-4">
                                            <span className="product-price regular-price">₹1529.00</span>
                                            <del className="product-price compare-price ms-2">₹1759.00</del>
                                        </div>
                                        ...
                                        <div className="misc d-flex align-items-end justify-content-between mt-4">
                                            <div className="quantity d-flex align-items-center justify-content-between">
                                                <button className="qty-btn dec-qty"><img src={`${process.env.PUBLIC_URL}/assets/img/icon/minus.svg`}
                                                    alt="minus" /></button>
                                                <input className="qty-input" type="number" name="qty" value="1" min="0" />
                                                <button className="qty-btn inc-qty"><img src={`${process.env.PUBLIC_URL}/assets/img/icon/plus.svg`}
                                                    alt="plus" /></button>
                                            </div>
                                        ...
                                        <form className="product-form" action="#">
                                            ...
                                            <div className="buy-it-now-btn mt-2">
                                                <button type="submit" className="position-relative btn-atc btn-buyit-now">BUY IT
                                                    NOW</button>
                                            </div>
                                        </form>
                            ...
                            <div className="tab-list product-tab-list">
                                <nav className="nav product-tab-nav">
                                    <Link className="product-tab-link tab-link active" href="#pdescription"
                                        data-bs-toggle="tab">Description</Link>
                                    <Link className="product-tab-link tab-link" href="#pshipping" data-bs-toggle="tab">Shipping &
                                        Returns</Link>
                                    <Link className="product-tab-link tab-link" href="#pstyle" data-bs-toggle="tab">Style with</Link>
                                    <Link className="product-tab-link tab-link" href="#preview" data-bs-toggle="tab">Reviews</Link>
                                </nav>
                            </div>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-7 col-md-12 col-12">
                                            <div className="desc-content">
                                                <h4 className="heading_34 mb-3">
                                                    Edius Gold Projects | Best Edius Projects | Edit Zone Projects</h4>

                                                <p className="text_16 mb-4">Edius Gold are ready made video projects. It’s a home
                                                    production of Edit Zone. Edius Gold Projects had been launched in Photo
                                                    Video Asia 2018 in Gandhinagar, Gujrat. After Successful 1 year we had
                                                    launched Gold 2.0 with Choose’A Effect – Transitions & Filters. We are
                                                    serving in Edius Gold Projects series with ready made all functions
                                                    projects. You will find a variaty of ready made projects i.e. Wedding
                                                    Teaser, Wedding Highlights, Portrait Songs, Cinematic Title, Birthday
                                                    Highlights, Pre-weddings, Pre-wedding teaser, Save the date, Studio Logos,
                                                    Online Vidhi projects and lots of editing utilities with unlimited video
                                                    backgrounds, effects, music and Luts. Edius Gold Projects is compatible with
                                                    all versions of Edius Software.
                                                </p>
                                        ...
                                        <div className="col-lg-5 col-md-12 col-12">
                                            <div className="desc-img">
                                                <img src={`${process.env.PUBLIC_URL}/assets/img/products/edit-zone-gold-projects.png`} alt="img" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="row justify-content-center">
                                ...
                                <div className="col-lg-4 col-md-6 col-12">
                                    <div className="product-card shadow-sm">
                                        <div className="product-card-img text-center">
                                            <Link className="hover-switch" href="#">
                                                <img className="primary-img product-img"
                                                    src={`${process.env.PUBLIC_URL}/assets/img/products/insidelogic-album-sense.png`} alt="product-img" />
                                            </Link>

                                            <div className="product-card-action product-card-action-2">
                                                <Link to="#quickview-modal" className="quickview-btn btn-primary"
                                                    data-bs-toggle="modal" data-product-id="Album-Sense"
                                                    data-product-name="Album Sense" data-product-price="1529.00"
                                        ...
                                        <div className="product-card-details text-center pb-3">
                                            <h3 className="product-card-title"><Link to="#">Album Sense</Link>
                                            </h3>
                                ...
                                <div className="col-lg-4 col-md-6 col-12">
                                    <div className="product-card shadow-sm">
                                        <div className="product-card-img text-center">
                                            <Link className="hover-switch" href="#">
                                                <img className="primary-img product-img"
                                                    src={`${process.env.PUBLIC_URL}/assets/img/products/grass-valley-edius-11.png`} alt="product-img" />
                                            </Link>

                                            <div className="product-card-action product-card-action-2">
                                                <Link to="#quickview-modal" className="quickview-btn btn-primary"
                                                    data-bs-toggle="modal" data-product-id="Edius-11"
                                                    data-product-name="Edius 11" data-product-price="1000.00"
                                ...
                                <div className="col-lg-4 col-md-6 col-12">
                                    <div className="product-card shadow-sm">
                                        <div className="product-card-img text-center">
                                            <Link className="hover-switch" href="#">
                                                <img className="primary-img product-img" src={`${process.env.PUBLIC_URL}/assets/img/products/cut-sense.png`}
                                                    alt="product-img" />
                                            </Link>

                                            <div className="product-card-action product-card-action-2">
                                                <Link to="#quickview-modal" className="quickview-btn btn-primary"
                                                    data-bs-toggle="modal" data-product-id="Cut-Sense"
                                                    data-product-name="Cut Sense" data-product-price="1529.00"
                                                    data-product-compare-price="1759.00"
