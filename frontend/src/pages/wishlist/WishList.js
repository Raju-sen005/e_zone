                                        ...
                                        items?.items?.map((item, index) => {
                                            return (
                                                <div className="col-lg-4 col-md-6 col-6" key={index} >
                                                    ...
                                                    <div className="product-card shadow p-4">
                                                        <div className="product-card-img">
                                                            <Link className="hover-switch" href="edius11.html">
                                                                <img className="primary-img" src={item?.images[0]?.url}
                                                                    alt="product-img" />
                                                            </Link>

                                                            <div className="product-card-action product-card-action-2 justify-content-center">
                                                                <Link to="#quickview-modal" className="action-card action-quickview"
                                                                ...
                                                                <Link to="/wishlist" className="action-card action-wishlist">
                                                                ...
                                                                <Link to="/cart" className="action-card action-addtocart">
                                                        ...
                                                        <div className="product-card-details">
                                                            <h3 className="product-card-title">
                                                                <Link to="/edius11" style={{ textDecoration: "none" }}>{item?.name}</Link>
                                                            </h3>
                                                            <div className="product-card-price">
                                                                <span className="card-price-regular">₹{item?.sellPrice}</span>
                                                                <span className="card-price-compare text-decoration-line-through">₹{item?.mrp}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
