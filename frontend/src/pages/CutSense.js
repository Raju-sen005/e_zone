                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6 col-md-12 col-12">
                                    <div className="product-details ps-lg-4">
                                        ...
                                        <h2 className="product-title mb-3">Cut Sense</h2>
                                        ...
                                        <div className="product-price-wrapper mb-4">
                                            ...
                                            <del className="product-price compare-price ms-2">₹1859.00</del>
                                        </div>
                                        ...
                                        {/* <form className="product-form" action="cart.html"> */}
                                        <div
                                            className="product-form-buttons d-flex align-items-center justify-content-between mt-4">
                                            <button type="submit" className="position-relative btn-atc btn-add-to-cart loader"
                                                onClick={() => isLoggedIn ? handleAddToCart() : navigate("/login")}>ADD TO CART</button>
                            ...
                            <div className="tab-list product-tab-list">
                                <nav className="nav product-tab-nav">
                                    <a className="product-tab-link tab-link active" href="#pdescription"
                                        data-bs-toggle="tab" style={{ textDecoration: "none" }}>Description</a>
                                    <a className="product-tab-link tab-link" href="#pshipping" data-bs-toggle="tab" style={{ textDecoration: "none" }}>Shipping &
                                        Returns</a>
                                    <a className="product-tab-link tab-link" href="#pstyle" data-bs-toggle="tab" style={{ textDecoration: "none" }}>Style with</a>
                                    <a className="product-tab-link tab-link" href="#preview" data-bs-toggle="tab" style={{ textDecoration: "none" }}>Reviews</a>
                                </nav>
                            </div>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-7 col-md-12 col-12">
                                            <div className="desc-content">
                                                ...
                                                <p className="text_16 mb-2">Edit Zone Presents Automatic Image Cutting Solution –
                                                    Cut Sense.
                                                </p>


                                                <p className="text_16 mb-2">Automatic selection by Inner / Outer Marquee Method.
                                                </p>


                                                <p className="text_16 mb-2">Automatic Selection / Cutting by Extract Object Method
                                                </p>


                                                <p className="text_16 mb-3">We provide all Selection tools like Magic Wand, Polygon
                                                    Lasso, Rectangle Marquee, Elipse with Inverse Selection, Multiple Selection,
                                                    Feather facility and Eraser. History Brush, for Special Cutting and Editing
                                                    Selection by selected Color in CutSense. So Enjoy Image Cutting with
                                        ...
                                        <div className="col-lg-5 col-md-12 col-12">
                                            <div className="desc-img">
                                                <img src={`${process.env.PUBLIC_URL}/assets/img/products/cut-sense.png`} alt="img" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="product-card shadow-sm">
                                        <div className="product-card-img text-center">
                                            ...
                                            <div className="product-card-action product-card-action-2">
                                                ...
                                                <button className="addtocart-btn btn-primary"
                                        ...
                                        <div className="product-card-details text-center pb-3">
                                            <h3 className="product-card-title"><a href="/">Album Sense</a>
                                            </h3>
                                ...
                                <div className="col-lg-4 col-md-6 col-12">
                                    <div className="product-card shadow-sm">
                                        <div className="product-card-img text-center">
                                            <a className="hover-switch" href="/">
                                                <img className="primary-img product-img"
                                                    src={`${process.env.PUBLIC_URL}/assets/img/products/edit-zone-gold-projects.png`} alt="product-img" />
                                            </a>

                                            <div className="product-card-action product-card-action-2">
                                                <a href="#quickview-modal" className="quickview-btn btn-primary"
                                                    data-bs-toggle="modal" data-product-id="Gold-Projects-Edit-Zone"
                                                    data-product-name="Gold Projects Edit Zone" data-product-price="1529.00"
                                                    data-product-compare-price="1759.00"
