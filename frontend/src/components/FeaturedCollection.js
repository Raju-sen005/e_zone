...
import QuantityAndMessage from './QuantityAndMessage';
import ProductImageGallery from './ProductImageGallery';
import { useNavigate } from 'react-router-dom';
import { useSelector } from 'react-redux';

const FeaturedCollection = ({ hideTitle = false }) => {
                                        ...
                                        <div className="product-details ps-lg-4">
                                            ...
                                            <form class="product-form" action="#">
                                                <div class="product-form-buttons d-flex align-items-center justify-content-between mt-4">
                                                    <a href="/cart" class="position-relative btn-atc btn-add-to-cart loader" onclick="addToCart('${name}')" style={{ textDecoration: "none" }}>ADD TO CART</a>
                                                ...
                                                <div class="buy-it-now-btn mt-2">
                                                    <button type="button" class="position-relative btn-atc btn-buyit-now">BUY IT NOW</button>
                                                </div>
                                            </form>
